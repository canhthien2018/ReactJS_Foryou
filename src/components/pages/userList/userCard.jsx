...
function UserCard({ avatar, info, editOnClick, viewOnClick }) {
    return (
        <>
            <Box sx={{
                position: 'relative',
                ...
                <Box sx={{ pr: 2, pl: 2, display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
                    <Avatar sx={{ borderRadius: '50%', width: 100, height: 100, mb: 1 }} alt='Logo' src={avatar ? avatar : maleAvatar}></Avatar>
                    <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', }}>
                        <Tooltip title="More Detail">
                            <IconButton sx={{ border: '2px solid white', p: 0.5 ,mr: 1, backgroundColor: th => th.palette.primary.dark  }} onClick={viewOnClick}>
                                <RemoveRedEyeIcon sx={{ color: 'white', fontSize: '16px'}} />
                            </IconButton>
                        </Tooltip>
                        <Tooltip title="Edit">
                            <IconButton sx={{ border: '2px solid white', p: 0.5, backgroundColor: th => th.palette.primary.dark  }} onClick={editOnClick}>
